    ...
    <style>
        *{
        ...
        .zpxx-window{
            ...
            position: relative;
            z-index: 1;
            background-image:-webkit-linear-gradient(right,antiquewhite,aqua,aquamarine,aliceblue) ;
            overflow: auto;
        }
        .card-container{
            display: flex;
...
<body>
<div style="text-align: center;background-image: -webkit-linear-gradient(right,aliceblue,lightcoral,lightskyblue,antiquewhite);font-size:4em;color:white">招聘信息</div>
<hr>
<div class="zpxx-window">
    <div class="card-container" >
    <c:forEach items="${xnsxs}" var="temp">
        <div class="card-job">
            <div class="card-left">
                <div class="card-left-up"><div style="font-size: 2em">${temp.time}</div></div>
                <div class="card-left-down"><div style="font-size: 2em">${temp.date}</div></div>
            </div>
            <div class="card-right">
                <div class="card-right-head"><span style="font-weight: bold">${temp.head}</span> </div>
                <div class="card-right-content">&blank;&blank;<span>${temp.content}</span></div>
            </div>
        </div>
    </c:forEach>
    </div>
...
<script type="module">
    $('.card-container').ready(function (){
        let sons=$('.card-container').children();
        console.log(sons.length);
        console.log(sons[0].targetHeight);
        for(let i=0;i<sons.length;i++)
        {
            $(sons[i]).ready(function ()
            {
                $(sons[i]).click(function (){
                    $(sons[i]).css("width","100%");
                    $(sons[i]).css("height","1080px");
...
<%--    <div class="card-job">--%>
<%--        <div class="card-left">--%>
<%--            <div class="card-left-up"><div style="font-size: 2em">15:00</div></div>--%>
<%--            <div class="card-left-down"><div style="font-size: 2em">6月17日</div></div>--%>
<%--        </div>--%>
<%--        <div class="card-right">--%>
<%--            <div class="card-right-head"><span style="font-weight: bold">中国信科集团校内双选招聘会</span> </div>--%>
<%--            <div class="card-right-content">&blank;&blank;<span>中国信科集团校内双选招聘会中国信科集团校内双选招聘会中国信科集团校内双选招聘会中国信科集团校内双选招聘会中国信科集团校内双选招聘会中国信科集团校内双选招聘会</span></div>--%>
<%--        </div>--%>
