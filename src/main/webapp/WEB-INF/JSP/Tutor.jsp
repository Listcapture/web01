...
<div style="text-align: center;background-image: -webkit-linear-gradient(right,aliceblue,lightcoral,lightskyblue,antiquewhite);font-size:4em;color:white">讲师</div>
...
<div class="introduction">
    <div class="description">
        <div class="p-card">
            <div class="card">
                <div class="photo">
                    <img src="resources/讲师/单莹.png" alt="" />
                </div>
                <h1>单莹</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em;">
   单颖，博士，讲师，主要研究方向：软件工程,林
   业信息。参与科研项目多项，并发表相关论文。
   所在学科：软件工程，软件工程（专业学位）
 </pre>
                <a href="Tutor">了解更多</a>
            </div>
            <div class="card">
                <div class="photo">
                    <img src="resources/讲师/王波.jpg" alt="" />
                </div>
                <h1>王波</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
  王波，讲师，硕士。主要研究方向：计算数学，软件
  开发。发表学术论文3篇。
              </pre>
                <a href="Tutor">了解更多</a>
            </div>
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/讲师/李琰.jpg" alt="" />
                </div>
                <h1>李琰</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
  李琰，讲师，主要研究方向：软件工程，遥感和林业
  信息。参与科研项目多项，参编教材1部，并发表部
  分相关论文。
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/讲师/边继龙.png" alt="" />
                </div>
                <h1>边继龙</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
  边继龙，讲师，工学博士，硕士生导师，软件工程
  专业副主任，支部委员，毕业于哈尔滨工程大学计
  算机应用技术专业，美国印第安纳大学访问学者。
  主要研究方向：计算机视觉，深度学习，生物信息
  学等方面的研究。主持黑龙江省自然科学基金面上
  项目、中央高校基本科研经费项目3项科研项目。
  累计发表学术论文20余篇，其中被EI/SCI收录
  10余篇，发明及实用新型专利3项。
  所在学科：软件工程（专业学位）
