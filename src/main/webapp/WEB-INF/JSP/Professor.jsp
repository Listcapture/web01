...
<div style="text-align: center;background-image: -webkit-linear-gradient(right,aliceblue,lightcoral,lightskyblue,antiquewhite);font-size:4em;color:white">教授</div>
...
<div class="introduction">
  <div class="description">
    <div class="p-card">
      <div class="card">
        <div class="photo">
          <img src="resources/教授/李莉.png" alt="" />
        </div>
        <h1>李莉</h1>
        <h2></h2>
<pre style="overflow: scroll;font-size:0.8em;">
   &nbsp;李莉，博士，教授，硕士生导师，东北林业大学青年
   &nbsp;成栋名师、软件工程专业主任、专业党支部书记。美
   &nbsp;国加州大学（河滨）访问学者。主持和参加国家级、
   &nbsp;省部级各类科研、教研项目15项，各级各类获奖10余
   &nbsp;项，作为第一作者发表SCI、EI、中文核心期刊等论
   &nbsp;文20余篇、主编教材4部。主持国家级一流本科课程、
   &nbsp;黑龙江省线上线下精品课程、东北林业大学一流本科
   &nbsp;课程、东北林业大学重点课程。获得第二届全国高校
   &nbsp;混合式教学设计创新大赛一等奖、华为产学合作专项
   &nbsp;奖；2次入选黑龙江省在线教学优秀案例；多次获得
   &nbsp;东北林业大学教学质量优秀奖、教学改革奖、教书育
   &nbsp;人先进个人称号。所在学科：计算机科学与技术，软
   &nbsp;件工程（专业学位）
   &nbsp;邮箱：lli@nefu.edu.cn
 </pre>
        <a href="Professor">了解更多</a>
      </div>
      <div class="card">
        <div class="photo">
          <img src="resources/教授/邱兆文.jpg" alt="" />
        </div>
        <h1>邱兆文</h1>
        <h2></h2>
        <pre style="overflow: scroll;font-size:0.8em">
  &nbsp;邱兆文，博士，教授，博士生导师。博士毕业于哈工
  &nbsp;大，美国卡内基梅隆大学访问学者。东北林业大学三
  &nbsp;维数字化技术研究所所长。黑龙江省医学影像三维可
  &nbsp;视化与3D打印工程技术中心主任。拓盟科技董事长。
  &nbsp;中国计算机学会（CCF）理事，CCF杰出会员，CCF
  &nbsp;计算机应用专委常务委员，CCF哈尔滨执行委员，中
  &nbsp;国抗癌协会人工智能专委委员。主要研究方向为人工
  &nbsp;智能、混合现实。主持参加国家自然科学基金、科技
  &nbsp;部中央引导地方重大专项基金等18项。国家发明专利
  &nbsp;5项。主编专著1部。在Nature Machine Intell
  &nbsp;igence等期刊发表SCI论文20篇，H-index为6。
  &nbsp;获省科技进步三等奖 2项，获省高等教育教学成果二
  &nbsp;等奖2项。2016年获第五届“中国创新创业大赛”互联
  &nbsp;网及移动互联网行业企业组第三名 。2020年获第四
  &nbsp;届“中国创翼”创业创新大赛全国三等奖。2018年入选
  &nbsp;科技部创新人才推进计划，2019年入选国家万人计划
  &nbsp;领军人才。2019年获黑龙江省十大杰出创业青年。
  &nbsp;2022年获第八届“黑龙江省优秀科技工作者”。2020
  &nbsp;年挑战杯竞赛国赛金奖指导教师。2021年“互联网+”
  &nbsp;大赛国赛银奖指导教师。哈工大客座教授。
  &nbsp;所在学科：林业工程（林业信息工程）博导
