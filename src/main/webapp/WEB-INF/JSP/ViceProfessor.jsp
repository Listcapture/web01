...
<div style="text-align: center;background-image: -webkit-linear-gradient(right,aliceblue,lightcoral,lightskyblue,antiquewhite);font-size:4em;color:white">副教授</div>
...
<div class="introduction">
    <div class="description">
        <div class="p-card">
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/刘丹.jpg" alt="" />
                </div>
                <h1>刘丹</h1>
                <h2></h2>
<pre style="overflow: scroll;font-size:0.8em;">
   &nbsp;刘丹，副教授，工学博士，硕士生导师。主要研究
   &nbsp;方向：无线传感器网络相关技术、数据仓库，数据
   &nbsp;挖掘。主持或参与科技部支撑计划项目、省自然科
   &nbsp;学基金项目、省科技攻关项目、哈尔滨科技局项目、
   &nbsp;中央高校基本可言业务C类项目等科研、教学项目
   &nbsp;20余项，出版教材7部，发表论文10余篇，其中
   &nbsp;EI收录论文7篇。获黑龙江省科技进步三等奖1项，
   &nbsp;省级奖励2项。授权发明专利、实用新型专利、软
   &nbsp;件著作权10余项。
 </pre>
                <a href="ViceProfessor">了解更多</a>
            </div>
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/张锡英.jpg" alt="" />
                </div>
                <h1>张锡英</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
    &nbsp;张锡英， 副教授，硕士，硕士生导师。主要研究方
    &nbsp;向：现代信息技术及网络应用，数据库技术、图像检
    &nbsp;索。主持或参加科研项目 11 项，发表论文 9 篇，
    &nbsp;出版教材 2 部。获得省级科学技术进步奖1次， 2
    &nbsp;门课精品课主讲教师。
    ...
    &nbsp;Email：zhangxy@nefu.edu.cn
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/温雪岩.jpg" alt="" />
                </div>
                <h1>温雪岩</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
    &nbsp;温雪岩，软件工程专业领域负责人，硕士，副教授，
    &nbsp;硕士生导师；黑龙江省计算机学会教育委员会委员。
    &nbsp;主要研究方向：算法与程序设计与开发、机器学习
    &nbsp;与深度学习、软件服务工程。主持或参加科研、教
    &nbsp;学项目10项，科研与教学获奖3项。出版教材5部，
    &nbsp;发表论文20余篇，EI1篇。
    &nbsp;所在学科：计算机科学与技术，软件工程（专业学位）
    &nbsp;Email：635108363@qq.com
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/罗思卿.png" alt="" />
                </div>
                <h1>罗思卿</h1>
                <h2></h2>
<pre style="overflow: scroll;font-size:0.8em">
    &nbsp;罗嗣卿，硕士，副教授，硕士生导师。主要研究方
    &nbsp;向：信息系统析与设计、图像处理、软件服务与应
    &nbsp;用。主持和参加省攻关重点、省自然基金、国家林
    &nbsp;业公益性行业专项、省教改项目15项，发表论文2
    &nbsp;0余篇，教材3部。
    &nbsp;所在学科：软件工程，软件工程（专业学位）
    &nbsp;Email：luosq@nefu.edu.cn
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/谷志新.png" alt="" />
                </div>
                <h1>谷志新</h1>
                <h2></h2>
                <pre style="overflow: scroll;font-size:0.8em">
   谷志新，博士，副教授，硕士生导师。主持黑龙
   江省自然科学基金、哈尔滨市应用技术研究与开
   发项目、中央高校基本科研业务费专项基金项目
   5项；获得哈尔滨市科技进步三等奖，东北林业
   大学教学质量优秀奖；主要研究方向：人工智能、
   信息技术应用。发表科技论文20余篇，其中SCI、
   EI收录5篇，出版专著1部，主编教材2部。获得
   专利4项。所在学科：软件工程，软件工程（专
   业学位）
   邮箱：gzx@nefu.edu.cn
            ...
            <div class="card">
                <div class="photo">
                    <img src="resources/副教授/赵玉茗.jpg" alt="" />
                </div>
                <h1>赵玉茗</h1>
                <h2></h2>
<pre style="overflow: scroll;font-size:0.8em">
    &nbsp;赵玉茗，博士，副教授，博士生导师。主要研究方
    &nbsp;向：生物信息学、数据挖掘。中国计算机学会生物
    &nbsp;信息专委会委员。主持国家自然科学基金面上项目、
    &nbsp;国家自然科学基金青年基金项目、国家重点研发项
    &nbsp;目子课题、黑龙江省自然科学基金、林木遗传育种
    &nbsp;国家重点实验室开放基金、中央高校基本科研业务
    &nbsp;费专项基金项目等多项科研项目；获得东北林业大
    &nbsp;学青年教师授课大赛二等奖；主讲精品在线课程1
    &nbsp;门；获得专利5项；发表学术论文30余篇，其中E
    &nbsp;I、SCI收录10余篇，参与编写教材1部。美国In
    &nbsp;diana University-Purdue University
    &nbsp;Indianapolis访问学者，美国The Johns H
    &nbsp;opkins University博士后访问学者。
    &nbsp;所在学科：林业工程（生物学）博导；计算机科学
    &nbsp;与技术（学硕及专业学位）硕导
    &nbsp;邮箱：zym@nefu.edu.cn
</pre>
                <a href="ViceProfessor">了解更多</a>
